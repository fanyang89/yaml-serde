...
/// }
///
/// # fn try_main() -> Result<(), yaml_serde::Error> {
/// let data = r#" { "level": 42 } "#;
/// let s: Settings = yaml_serde::from_str(data)?;
///
...
/// A YAML sequence in which the elements are `yaml_serde::Value`.
pub type Sequence = Vec<Value>;

/// Convert a `T` into `yaml_serde::Value` which is an enum that can represent
/// any valid YAML data.
///
...
/// Interpret a `yaml_serde::Value` as an instance of type `T`.
///
...
impl Value {
    ...
    /// #
    /// # fn main() -> yaml_serde::Result<()> {
    /// let object: Value = yaml_serde::from_str(r#"
    /// A: [a, á, à]
    /// B: [b, b́]
    /// C: [c, ć, ć̣, ḉ]
    /// 42: true
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("null").unwrap();
    /// assert!(v.is_null());
    /// ```
    ///
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("false").unwrap();
    /// assert!(!v.is_null());
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("true").unwrap();
    /// assert!(v.is_bool());
    /// ```
    ///
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("42").unwrap();
    /// assert!(!v.is_bool());
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("5").unwrap();
    /// assert!(v.is_number());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("1337").unwrap();
    /// assert!(v.is_i64());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("256.01").unwrap();
    /// assert!(v.is_f64());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("13.37").unwrap();
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("'lorem ipsum'").unwrap();
    /// assert!(v.is_string());
    /// ```
    ///
    /// ```
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("[1, 2, 3]").unwrap();
    ...
    ///
    /// ```
    /// # use yaml_serde::{Value, Number};
    /// let v: Value = yaml_serde::from_str("[1, 2]").unwrap();
    ...
    /// ```
    /// # use yaml_serde::{Value, Number};
    /// let mut v: Value = yaml_serde::from_str("[1]").unwrap();
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let mut v: Value = yaml_serde::from_str("false").unwrap();
    ...
    /// ```
    /// # use yaml_serde::Value;
    /// let v: Value = yaml_serde::from_str("a: 42").unwrap();
    /// assert!(v.is_mapping());
    /// ```
    ///
    /// ```
    ...
    ///
    /// ```
    /// # use yaml_serde::{Value, Mapping, Number};
    /// let v: Value = yaml_serde::from_str("a: 42").unwrap();
    ///
    ...
    /// ```
    /// # use yaml_serde::{Value, Mapping, Number};
    /// let mut v: Value = yaml_serde::from_str("a: 42").unwrap();
