...
/// A type that can be used to index into a `yaml_serde::Mapping`. See the
...
/// Iterator over `&mut yaml_serde::Mapping`.
...
/// Iterator over `yaml_serde::Mapping` by value.
pub struct IntoIter {
...
/// Iterator of the values of a `&yaml_serde::Mapping`.
pub struct Values<'a> {
...
/// Iterator of the values of a `&mut yaml_serde::Mapping`.
