...
[<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/yaml/yaml-serde/ci.yml?branch=master&style=for-the-badge" height="20">](https://github.com/yaml/yaml-serde/actions?query=branch%3Amaster)
